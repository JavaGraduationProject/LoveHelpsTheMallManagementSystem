...
<body>
	...
	<div class="page-container">
		...
		<div class="text-c">
			<input type="hidden" name="basepath" id="basepath" value="<%=basePath%>"> <input type="text" name="start" id="start"
				required style="width: 200px" class="input-text" onclick="WdatePicker()" readonly="readonly" />&nbsp;&nbsp; <input
				type="text" name="end" id="end" required style="width: 200px" class="input-text" onclick="WdatePicker()"
				readonly="readonly" />
